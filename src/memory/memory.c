...
/*   Updated: 2023/08/28 22:38:22 by htsang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t amount_of_intersections)
{
	...
	if (mrt_allocator_init(&allocator->rays, \
		...
		sizeof(t_mrt_matrix), amount_of_matrices) || \
		mrt_allocator_init(&allocator->intersections, \
		sizeof(struct s_mrt_intersection), amount_of_rays))
	{
...
inline t_mrt_matrix	*mrt_allocate_matrix(\
struct s_mrt_uniform_allocator *allocator)
{
